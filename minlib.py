"""
    This 'Minionese' translation dictionary is derived from
      https: //github.com/brycedorn/miniontranslator/blob/master/js/library.js
    by Bryce Dorn

    Converted from js to Python with the help of my best friend!!
        (see:  js-to-python.r)
    Matthew Wolff (https: //github.com/matthewwolff)
"""
